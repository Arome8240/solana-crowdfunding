...
export const getProviderReadonly = (): Program<Anchor> => {
  const connection = new Connection(RPC_URL, "confirmed");
...
export const fetchCampaignDetails = async (
  ...
  useGlobalStore.getState().setCampaign(serialized);
...
export const fetchAllDonations = async (
  ...
  useGlobalStore.getState().setDonations(serializedTxs(donations));
...
export const fetchAllWithsrawals = async (
  ...
  useGlobalStore.getState().setWithdrawals(serializedTxs(withdrawals));
...
export const fetchProgramState = async (
  ...
  useGlobalStore.getState().setStates(serialized);
  return serialized;
};
